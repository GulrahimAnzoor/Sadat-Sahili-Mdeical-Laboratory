...
<html lang="en">
    ...
    <body>
        <main>
            <h1>{{ __('The laboratory system could not complete that action.') }}</h1>
            <p>{{ __('Try again. If the problem continues, restore the latest database backup or contact your system installer.') }}</p>
