...
<html lang="en">
    ...
    <body>
        <main>
            <h1>{{ __('You do not have permission for this page.') }}</h1>
            <p>{{ __('Ask a laboratory administrator to update your staff role if you need access.') }}</p>
